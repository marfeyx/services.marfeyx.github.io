...
const translations = {
	...
	de: {
		...
		'footer.socials': 'Socials',
		'footer.email': 'contact.marfeyx@gmail.com',
		'footer.copy': 'Mit Absicht gebaut - Immer responsive',
		...
		'hero.card1.value': '1 Monat Lieferung',
		...
		'hero.card3.hint': 'Ich schreibe eine verständliche Dokumentation, damit man den Code später ändern kann.',

		'offers.eyebrow': 'Angebote',
		'offers.title': 'Wähle den Build, der zu deinem Umfang passt.',
		'offers.body': 'Von einer schnellen One-Page bis zur kompletten Progressive Web App. Jedes Angebot kommt mit sauberem Code, responsive Layouts und klarer Dokumentation.',
		'offers.packages.eyebrow': 'Pakete',
		'offers.packages.title': 'Wähle deinen Umfang',
		'offers.pkg1.tier': 'Personal Project',
		'offers.pkg1.title': 'Komplette statische Website',
		...
		'offers.pkg3.title': 'Komplette Progressive Web App',
		...
		'offers.addons.seo.title': 'Premium SEO Setup',
		'offers.addons.seo.body': 'Ø 95%+ SEO Rating garantiert pro Seite',
		'offers.addons.seo.price': '39.95 CHF',
		'offers.addons.seo.unit': '*',
		'offers.addons.analytics.tag': 'Schnell & zuverlässig',
		'offers.addons.analytics.title': 'Lighthouse Performance 95%+ garantiert',
		'offers.addons.analytics.body': 'Bilder und Elemente werden für beste Performance optimiert.',
		'offers.addons.analytics.price': '39.95 CHF',
		'offers.addons.analytics.unit': '*',
		'offers.addons.cms.tag': 'Flexibel',
		'offers.addons.cms.title': 'Mehrsprachig',
		'offers.addons.cms.body': 'Bis zu 3 integrierte Übersetzungen.',
		'offers.addons.cms.price': '49.95 CHF',
		...
		'custom.checkout.body': 'Hier wird noch nichts berechnet, es wird nur eine Anfrage erstellt.',
		'custom.checkout.selectedPackage': 'Gewähltes Paket',
		'custom.checkout.packageFallback': 'Wähle ein Paket um weiterzumachen',
		...
		'custom.checkout.total': 'Geschätzter Total',
		...
		'form.body': 'Schreib mir direkt wegen Projekten.',
		'form.name': 'Name',
		'form.email': 'Email',
